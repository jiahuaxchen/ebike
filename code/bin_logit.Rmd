...
model_ebike_lump <- stan_glm(injury2 ~ .-i_type-regular_cyclist-bicycle_type,
                        data=ebike_lump,
                        family = binomial(link = "logit"),
                        offset = log(ebike_lump$pop),
                        seed = 1208,
...
model_pedal_lump <- stan_glm(injury2 ~ . - i_type - regular_cyclist - bicycle_type,
                        data=pedal_lump,
                        family = binomial(link = "logit"),
...
posterior_samples <- as.array(model_ebike_lump)
posterior_samples <- as.array(model_pedal_lump)

# Get the names of all parameters
parameter_names <- dimnames(posterior_samples)$parameters
...
mcmc_intervals(posterior_samples, pars = parameter_names) +
...
plot(ebike_model_itype, plotfun = "areas", prob = 0.9,
     pars = c("i_typecollison_fall"))

plot(ebike_model_itype, plotfun = "areas", prob = 0.95,
     pars = c("terrainDownhill"))
plot(ebike_model, plotfun = "areas", prob = 0.95,
     pars = c("terrainDownhill"))

plot(ebike_model_itype, plotfun = "areas", prob = 0.95,
     pars = c("incident_withother","incident_withbicyclist","incident_withpedestrian"))
plot(ebike_model, plotfun = "areas", prob = 0.95,
     pars = c("incident_withother","incident_withbicyclist","incident_withpedestrian"))
...
plot4 <- plot(model_ebike_lump, plotfun = "areas", prob = 0.95, pars = c("pop"))
...
## pedal bike
plot(model_pedal_lump, plotfun = "areas", prob = 0.95,
     pars = c("genderF"))
plot(model_pedal_lump, plotfun = "areas", prob = 0.95,
     pars = c("age_imp"))
plot(model_pedal_lump, plotfun = "areas", prob = 0.95,
