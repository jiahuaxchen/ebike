...
saveRDS(model_ebike_lump,"models/model_ebike_lump.rds")
...
saveRDS(model_pedal_lump,"models/model_pedal_lump.rds")
...
## pedal bike
plot1 <- plot(model_pedal_lump, plotfun = "areas", prob = 0.95,
     pars = c("genderF"))
plot2 <- plot(model_pedal_lump, plotfun = "areas", prob = 0.95,
     pars = c("age_imp"))
plot3 <- plot(model_pedal_lump, plotfun = "areas", prob = 0.95,
