...
st_write(all_Canada, "../data/derive/all_bike_Ca_pop_0425.shp",
         append=FALSE)
...
saveRDS(combined_neighbor_info,"../data/derive/combined_neighbor_info_Canada.rds")
